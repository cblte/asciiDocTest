...
This is just for me to try out some AsciiDoc features of Github.
...
To learn more, visit the AsciiDoc home page or this gist which lists the AsciiDoc 
compatible things with github https://gist.github.com/cblte/9c736c39b8dc6e8f5aef911da2a8a500[^]
